...
def titulo_sugiere_inmobiliaria(titulo: str) -> bool:
    ...
    palabras_inmobiliaria_seguras = {
        ...
        # Términos adicionales muy específicos de inmobiliarias
        'realty', 'realty group', 'realty services',
        'property management', 'property services',
        'home services', 'home solutions',
        'real estate solutions', 'real estate services',
        'luxury homes', 'luxury properties', 'luxury real estate',
        'exclusive properties', 'exclusive homes',
        'premium homes', 'premium properties',
        'investment properties', 'investment homes',
        'commercial real estate', 'commercial properties',
        'residential real estate', 'residential properties',
        'real estate agency', 'real estate broker',
        'property broker', 'home broker',
        'real estate consultant', 'property consultant',
        'real estate advisor', 'property advisor',
        'real estate expert', 'property expert',
        'real estate specialist', 'property specialist',
        'real estate professional', 'property professional',
        'real estate services', 'property services',
        'real estate solutions', 'property solutions',
        ...
        'real estate sales', 'property sales',
        'real estate rentals', 'property rentals',
        'real estate leasing', 'property leasing',
        'real estate listings', 'property listings',
        'real estate search', 'property search',
        'real estate find', 'property find',
        'real estate buy', 'property buy',
        'real estate sell', 'property sell',
        'real estate rent', 'property rent',
        'real estate lease', 'property lease',
        'real estate own', 'property own',
        'real estate live', 'property live',
        'real estate work', 'property work',
        'real estate invest', 'property invest',
        'real estate build', 'property build',
        'real estate develop', 'property develop',
        'real estate manage', 'property manage',
        'real estate consult', 'property consult',
        'real estate advise', 'property advise',
        'real estate expert', 'property expert',
        'real estate special', 'property special',
        'real estate pro', 'property pro',
        'real estate leader', 'property leader',
        'real estate top', 'property top',
        'real estate best', 'property best',
        'real estate quality', 'property quality',
        'real estate trust', 'property trust',
        'real estate reliable', 'property reliable',
        'real estate secure', 'property secure',
        'real estate network', 'property network',
        'real estate connect', 'property connect',
        'real estate global', 'property global',
        'real estate international', 'property international',
        'real estate world', 'property world',
        'real estate worldwide', 'property worldwide',
        'real estate premium', 'property premium',
        'real estate luxury', 'property luxury',
        'real estate exclusive', 'property exclusive',
        'real estate elite', 'property elite',
        'real estate select', 'property select',
        'real estate choice', 'property choice'
    }
    
    # === PALABRAS QUE INDICAN EMPRESA/NEGOCIO (solo las más seguras) ===
    palabras_empresa = {
        ...
        'staff', 'personal', 'servicio', 'servicios',  # Eliminado 'central', 'centro'
        ...
        # Términos adicionales que podrían usar inmobiliarias (solo los más seguros)
        'asesoría', 'asesoramiento', 'consultoría',
        'inmobiliario', 'finca raíz', 'finca urbana',
        ...
        'marketing inmobiliario', 'publicidad inmobiliaria',
        ...
        'garantía', 'garantías',  # Eliminado 'aval', 'avales'
        ...
        'ayuntamiento', 'consistorio', 'diputación',
